...
// 
  ...
  return (
    ...
    <div class="text">
      <h1 className='head'>Never stop learning.<br/> With TalentFort.</h1> 
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Welcome to TalentFort LEARNING</h1>
            ...
            {courseData && courseData.map((course,index) =>
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    <div class="course-item bg-light">
                        ...
                        <Link to={`/detail/${course.id}`}><img src={course.featured_img} height={250}  className="card-img-top" alt={course.title} /></Link>                        
                        </div>
