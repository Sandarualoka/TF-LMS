...
//     { id: 2, title: 'Module 3', description: 'Description for Module 2' },
...
//                   {module.description}
//                 </Typography>
//                 <button className="btn btn-danger mt-2" onClick={() => deleteModule(module.id)}>
//                   Delete Module
//                 </button>
//               </CardContent>
//             </Card>
...
//           <button className="btn btn-primary" onClick={addNewModule}>
//             Add New Module
//           </button>
//         </div>
//       </div>
